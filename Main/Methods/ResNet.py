...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.fc = nn.Sequential(
            ...
            nn.BatchNorm1d(512 * block.expansion // 2),
            nn.Hardswish(inplace=True),
            nn.Dropout(p=0.5),
            nn.Linear(512 * block.expansion // 2, 512 * block.expansion // 4),
            nn.BatchNorm1d(512 * block.expansion // 4),
            nn.Hardswish(inplace=True),
            nn.Linear(512 * block.expansion // 4, 64),
            nn.BatchNorm1d(64),
            nn.Hardswish(inplace=True),
